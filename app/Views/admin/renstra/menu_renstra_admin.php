...
<div class="card text-center">
  <div class="card-block">
    <a href="<?= base_url() ?>tujuan-renstra/add/<?= $opd['kode_opd']; ?>" class="btn btn-out-dashed <?= ($uri->getSegment(1) == 'tujuan-renstra') ? 'btn-primary' : 'btn-secondary'; ?> btn-square mb-2">Tujuan [<?= $jml_tujuan; ?>]</a>
